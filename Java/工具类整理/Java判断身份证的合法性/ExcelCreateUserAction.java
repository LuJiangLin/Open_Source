 ...
 * @author Mr.薛
 *  可以根据个人需求，如果想获取该身份证的人的详细信息的话可以直接将返回的类型改变做一个对象封装存储用户的各个信息 
 * 
 */  
...
public class ExcelCreateUserAction {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        String result = new ExcelCreateUserAction().getIdCard(IdCard);
...
//      身份证验证
    public String getIdCard(String IdCard) throws Exception
    {
    	//将身份证最后一位的x转换为大写，便于统一  
    	IdCard = IdCard.toUpperCase();  
