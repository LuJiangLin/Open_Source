...
/**
 * @author make it
 * @version SVN #V1# #2016-8-16#
 * @文件描述 geohash：用字符串实现附近地点搜索
 * URL  http://blog.charlee.li/geohash-intro/
 */
public class Geohash {
    ...
    public static void main(String[] args) {
        double[] latlon = new Geohash().decode("uxypyzyxyzfr");
        System.out.println(latlon[0] + " " + latlon[1]);

        Geohash e = new Geohash();
        String s = e.encode(121.50935, 31.24335);
    ...
    public String encode(double lat, double lon) {
        ...
        try {
            ...
            geohash = base32(Long.parseLong(buffer.toString(), 2));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return geohash;
